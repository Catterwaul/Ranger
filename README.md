...
[Read the documentation here. 📖](https://catterwaul.github.io/Ranger/documentation/ranger/) 

## Dependency 

Ranger is in the "Major Version Zero" phase, allowing for rapid development based on community feedback. 
